<?php
include("rlogin.php"); // Include logserv for checking username and password
?>
    ...
    <html>
        <head>
            <style>
                ...
                form {
                    margin: 80px auto;
                    border: 4px  #3f5a70 solid;   /*CSS for positioning coloring and bordering the form*/
