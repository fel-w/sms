...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Apr 23, 2018 at 11:13 AM
...
CREATE TABLE IF NOT EXISTS `accountant2` (
  `Email` varchar(100) NOT NULL,
  `Password` varchar(100) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

--
-- Dumping data for table `accountant2`
--

INSERT INTO `accountant2` (`Email`, `Password`) VALUES
('mk', ' mk'),
('c', ' c');
...
INSERT INTO `biodata` (`Surname`, `Othernames`, `MobileNumber`, `Email`, `Dateofbirth`, `Religion`, `Gender`, `Nationality`, `Maritalstatus`, `Residence`, `Name`, `EmailAddress`, `Relationship`, `MobileNo`, `Placeofresidence`, `referenceNo`, `Courses`, `reference`, `RegistrationNo`) VALUES
...
INSERT INTO `students` (`Surname`, `Othernames`, `MobileNumber`, `Email`, `Dateofbirth`, `Religion`, `Gender`, `Nationality`, `Maritalstatus`, `Residence`, `Name`, `EmailAddress`, `Relationship`, `MobileNo`, `Placeofresidence`, `referenceNo`, `Courses`, `reference`, `RegistrationNo`) VALUES
('kaskdkk', 'klkeioioe', '39389838377', 'kaamasu@gmail.com', '2018-04-10', 'jksdkj', 'male', 'mdflkkl', 'sdkdsklsd', 'jdkjlfkjfk', 'kvkkfjlkljfjkdjk', 'kakmasu@gmail.com', 'dsknkdfkjldf', 'kdfkgjkwrk', 'jdkjlfkjfk', 47, 'MASTERS OF IS', 'Accepted', 'SMS/47'),
('kaskdkk', 'klkeioioe', '39389838377', 'kaamasu@gmail.com', '2018-04-10', 'jksdkj', 'male', 'mdflkkl', 'sdkdsklsd', 'jdkjlfkjfk', 'kvkkfjlkljfjkdjk', 'kakmasu@gmail.com', 'dsknkdfkjldf', 'kdfkgjkwrk', 'jdkjlfkjfk', 48, 'MASTERS OF IS', 'Rejected', '');
